...
with st.sidebar:
    ...
    page = st.selectbox(
        ...
        label_visibility="collapsed"  # ini penting untuk hilangkan spasi label
    )



    st.markdown("---")
    st.caption("© 2025 ObeSync by Jasmine, Abel, Vica")
...
if page == "Beranda":
    st.markdown(
        ...
        <div style='text-align: center; line-height: 1;'>
            <h3 style='margin: 0;'>Selamat Datang di ObeSync 🎉</h3>
            <p style='margin: 0;'>Prediksi cerdas hidup sehat mulai hari ini.</p>
        </div>
        """,
        unsafe_allow_html=True
    )
